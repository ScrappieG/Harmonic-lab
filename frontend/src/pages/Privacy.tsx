...
<li>
<p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Articuleet.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Articuleet, accessible from <a href="https://articuleet.com" rel="external nofollow noopener" target="_blank">https://articuleet.com</a>.</p>
</li>
<li>
...
<ul>
<li>By email: <a href="mailto:swampswapdev@gmail.com">swampswapdev@gmail.com</a></li>
</ul>
`
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="layout-shell py-10 md:py-14">
        <section className="relative overflow-hidden rounded-[2rem] border border-stone-200/80 bg-white/85 px-6 py-8 shadow-[0_24px_80px_rgba(41,38,31,0.08)] backdrop-blur-sm sm:px-8 md:px-12 md:py-12">
          <div className="pointer-events-none absolute -left-20 top-0 h-40 w-40 rounded-full bg-lime-200/35 blur-3xl" />
          <div className="pointer-events-none absolute -right-16 bottom-6 h-44 w-44 rounded-full bg-stone-200/60 blur-3xl" />

          <div className="relative max-w-4xl">
            <p className="brand-mono text-xs uppercase tracking-[0.22em] text-stone-500">Privacy</p>
            <h1 className="brand-serif mt-4 text-4xl leading-none tracking-tight text-stone-900 sm:text-5xl md:text-6xl">
              Privacy Policy
            </h1>
            ...
            <div className="mt-10 h-px w-full bg-gradient-to-r from-stone-300 via-stone-200 to-transparent" />

            <article
              className="policy-content mt-10 max-w-none"
